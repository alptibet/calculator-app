...
const controlThemeSelect = function(theme) {
    ...
    _viewRenderTheme.renderTheme(theme);
};
...
const controlDelete = function(operand) {
    _model.deleteOperand(operand);
    _viewDisplay.updateDisplay(_model.state.displayValue);
};
const controlReset = function() {
    _model.resetCalculator();
    _viewDisplay.updateDisplay(_model.state.displayValue);
};
const init = function() {
    ...
    _viewReset.addHandlerReset(controlReset);
};
init();
...
parcelHelpers.export(exports, "setInitialTheme", ()=>setInitialTheme
);
parcelHelpers.export(exports, "setTheme", ()=>setTheme
);
parcelHelpers.export(exports, "setOperand", ()=>setOperand
);
parcelHelpers.export(exports, "deleteOperand", ()=>deleteOperand
);
parcelHelpers.export(exports, "setOperator", ()=>setOperator
);
parcelHelpers.export(exports, "resetCalculator", ()=>resetCalculator
);
const state = {
    displayValue: '0',
    firstOperand: null,
...
const setOperand = function(operand) {
    const { displayValue , waitingForSecondOperand  } = state;
    if (waitingForSecondOperand === true) {
        state.displayValue = operand;
        state.waitingForSecondOperand = false;
    } else state.displayValue = displayValue === '0' ? operand : displayValue + operand;
};
const deleteOperand = function(operand) {
    state.displayValue = operand;
};
const setOperator = function(operation) {
    ...
    if (firstOperand === null && !isNaN(inputValue)) state.firstOperand = parseFloat(inputValue);
    else if (operator) {
...
const calculate = function(firstOperand, secondOperand, operator) {
    if (operator === 'plus') return parseFloat(firstOperand) + parseFloat(secondOperand);
    else if (operator === 'minus') return parseFloat(firstOperand) - parseFloat(secondOperand);
    else if (operator === 'times') return parseFloat(firstOperand) * parseFloat(secondOperand);
    else if (operator === 'divide') return parseFloat(firstOperand) / parseFloat(secondOperand);
...
},{}],"2fyjX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addHandlerThemeSelect", ()=>addHandlerThemeSelect
);
const addHandlerThemeSelect = function(handler) {
...
const renderTheme = function(theme) {
    ...
    themeSelector.forEach(function(item) {
        if (item.dataset.theme === theme) item.checked = true;
    });
    const allItems = [
        body,
        ...children
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"367CR"}],"22PbF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"367CR"}],"7gBkX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handlerNums", ()=>handlerNums
);
const handlerNums = function(handler) {
    const numpad = document.querySelector('.numpad');
    numpad.addEventListener('click', function(event) {
        const { target  } = event;
        if (!target.matches('button')) return;
        if (target.classList.contains('operand')) handler(target.textContent);
    });
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"367CR"}],"4eWCJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "handlerOperation", ()=>handlerOperation
);
const handlerOperation = function(handler) {
    const numpad = document.querySelector('.numpad');
    numpad.addEventListener('click', function(event) {
        const { target  } = event;
        if (!target.matches('button')) return;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"367CR"}],"2wmbt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addHandlerDelete", ()=>addHandlerDelete
);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"367CR"}],"3oOLh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"367CR"}]},["1WnDs","3miIZ"], "3miIZ", "parcelRequire07b7")
